...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 01 mars 2024 à 08:25
...
(2, 1, 'Ile de Nantes', '16 Boulevard Général de Gaulle', 47.206227, -1.540066),
(3, 2, 'Sevran', '12 Avenue Léon Jouhaux', 48.94028, 2.533623),
(4, 2, 'Montreuil', '1 Place Jean Jaurès', 48.863692, 2.429949),
(5, 3, 'Minimes', '108 Bis Avenue des Minimes', 43.619045, 1.423361),
(6, 3, 'Les Arènes', '5 Place Émile Male', 43.590754, 1.416357),
(7, 4, 'Boutonnet', '2 Avenue Charles Flahault', 43.61994, 3.857567),
(8, 4, 'Antigone', '890 Avenue Jean Mermoz', 43.610144, 3.884216);
...
(1, 1, '[]', '$2y$13$Sh.VPWnC1Y/9APhv0tzfK.hy/F6JRw7w.XISn9.tblbddXnE.EuwC', 'Utilisateur', 'Public', NULL, 'user@test.com', 0, 1, 'User', NULL, 'user-65de046283e24517358842.csv', 118, '2024-02-27 15:48:50'),
(2, 2, '[\"ROLE_ADMIN\"]', '$2y$13$zKSy9.APeB5BsEAkT.XkGu/4Dt6df7cVO4j.O2U7z27zClESHiVfG', 'Utilisateur', 'Admin', NULL, 'admin@test.com', 0, 1, 'Admin', NULL, 'images-65df3a8a04a96036890436.jpg', 8478, '2024-02-28 13:52:10');
...
INSERT INTO `sortie` (`id`, `organisateur_id`, `site_id`, `lieu_id`, `etat_id`, `nom`, `date_heure_debut`, `duree`, `date_limite_inscription`, `nb_inscriptions_max`, `infos_sortie`) VALUES
(1, 1, 1, 1, 1, 'Sortie des familles', '2024-03-01 13:00:00', 60, '2024-03-01 00:00:00', 10, 'Ceci est une sortie test des familles !');
